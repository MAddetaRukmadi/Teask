...
package com.d121201070.teask.ui.task
...
import com.d121201070.teask.databinding.FragmentTaskBinding
import com.d121201070.teask.ui.task.TaskFragmentDirections
    ...
    override fun onCreateView(
        ...
        ItemTouchHelper(object  : ItemTouchHelper.SimpleCallback(0,
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                Snackbar.make(binding.root, "Task Dihapus!", Snackbar.LENGTH_LONG).apply {
                    setAction("Batal"){
